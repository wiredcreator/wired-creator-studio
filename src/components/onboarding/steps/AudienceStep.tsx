  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="space-y-2">
        ...
        <VoiceInputWrapper onTranscript={(text) => onChange({ talkWithoutPreparing: data.talkWithoutPreparing ? data.talkWithoutPreparing + '\n' + text : text })}>
        <textarea
      ...
      <div className="space-y-2">
        ...
        <VoiceInputWrapper onTranscript={(text) => onChange({ audienceAndProblem: data.audienceAndProblem ? data.audienceAndProblem + '\n' + text : text })}>
        <textarea
      ...
      <div className="space-y-2">
        ...
        <VoiceInputWrapper onTranscript={(text) => onChange({ uniquePerspective: data.uniquePerspective ? data.uniquePerspective + '\n' + text : text })}>
        <textarea
