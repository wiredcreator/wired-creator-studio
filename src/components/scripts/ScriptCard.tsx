    ...
    >
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        {script.ideaId && typeof script.ideaId === 'object' && (
          <span className="inline-flex items-center gap-1 rounded-[var(--radius-full)] bg-[var(--color-bg-secondary)] px-2.5 py-0.5 text-xs font-medium text-[var(--color-text-secondary)]">
