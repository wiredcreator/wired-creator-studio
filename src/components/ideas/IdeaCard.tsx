...
export default function IdeaCard({
  ...
  return (
    ...
    >
      ...
      {/* Action buttons -- pipeline: status dropdown + delete */}
            ...
            {showDeleteConfirm ? (
              <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                ...
                <button
                  ...
                  className="rounded-[var(--radius-sm)] bg-[var(--color-error)] px-2 py-1 text-xs font-medium text-white transition-colors hover:opacity-90"
                >
                  Yes
                </button>
                <button
                  ...
                  className="rounded-[var(--radius-sm)] px-2 py-1 text-xs font-medium text-[var(--color-text-muted)] transition-colors hover:bg-[var(--color-bg-secondary)]"
                >
                  No
                </button>
              </div>
              ...
              <button
                ...
                className="rounded-[var(--radius-md)] p-2 text-[var(--color-text-muted)] transition-colors hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-error)]"
                title="Delete idea"
              >
